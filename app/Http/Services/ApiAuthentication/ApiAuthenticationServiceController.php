...
class ApiAuthenticationServiceController
{
     ...
     * @return User
     */
    function validateUserClientId(Array $requestArray) {
        $user = User::find_first([['where', 'email', '=', $requestArray['client_id']]]);
        $request_client_secret = hash('sha256', $requestArray['client_secret']);
